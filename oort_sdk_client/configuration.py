...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of oort_sdk_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = oort_sdk_client.Configuration(
    ...
    Note you can use the constants defined in the oort_sdk_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = oort_sdk_client.Configuration(
        signing_info = oort_sdk_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost:2005/sdk/v1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("oort_sdk_client")
